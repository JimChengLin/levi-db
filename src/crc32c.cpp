...
namespace LeviDB {
    namespace CRC32C {
        static constexpr uint32_t _table0[256] = {
        ...
        static constexpr uint32_t _table1[256] = {
        ...
        static constexpr uint32_t _table2[256] = {
        ...
        static constexpr uint32_t _table3[256] = {
        ...
        static inline bool haveSSE42() noexcept {
            unsigned int eax, ebx, ecx, edx;
            __get_cpuid(1, &eax, &ebx, &ecx, &edx);
            return (ecx & (1 << 20)) != 0;
        }

        uint32_t acceleratedCRC32C(uint32_t crc, const char * buf, size_t size) noexcept {
